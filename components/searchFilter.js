...
export const SearchFilter = () => {
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        router.push(
            `/property/search?${values.title && `title=${values.title}`}${values.category && `&category=${values.category}`}`
        )
    }
                ...
                <div className="col-lg-5 col-md-5 col-6 firstCol">
                    <div className="input-group-sm mb-3">
                        <div className="input-group-prepend">
                            ...
                            <select name="category" onChange={handleChange("category")} value={values.category}
                ...
                <div className="col-lg-7 col-md-7 col-6 secondCol">
                    <div className="input-group-sm mb-3">
                        <div className="input-group-prepend">
                            ...
                            <input name="title" onChange={handleChange("title")} placeholder="Recherche"
                            className="form-control form-field" />
                               <span className="input-group-text customColor">
