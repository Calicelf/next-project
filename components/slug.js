...
export const Slug = ({property}) => {
    return (
        <div className="mt-4">
            <h1 className="globaleColor">{property.title}</h1>
            <hr className="my-3"/>
            ...
            <Collapse titre="Détails de la propriété">
                <section className="mt-3 pl-3">
                    <div>
                        <span className="font-weight-bolder">
                            Surface
                        </span> : {property.surface}
                    </div>
                    <div>
                        <span className="font-weight-bolder">
                            Prix
                        </span> : {priceFormatted(property.price)}
                    </div>
                    <div>
                        <span className="font-weight-bolder">
                            Chambre(s)
                    ...
                    <div>
                        <span className="font-weight-bolder">
                            Date de création
                        </span> : <Moment format="DD/MM/YYYY à hh:mm:ss">{property.createdAt}</Moment>
                    </div>
                </section>
            </Collapse>
            <style jsx>
